...
{
    recognizerCascade.load("/home/pi/opencvPro/opencvPro/haarcascade_frontalface_alt2.xml");//感觉用lbpcascade_frontalface效果没有它好，注意哈！要是正脸

    recognizerModel = FisherFaceRecognizer::create();
    //1.加载训练好的分类器
    recognizerModel->read("/home/pi/opencvPro/opencvPro/xml/MyFaceFisherModel.xml");// opencv2用load
}
void myFaceRecognizer::takePicture( Mat frame)
{
...
void myFaceRecognizer::train(string fn_csv)
{
...
void myFaceRecognizer::Recognizer( Mat frame)
{
...
//    {
        ...
        for (int i = 0; i < faces.size(); i++)
        {
           ...
           // text_lb = Point(faces[i].x, faces[i].y);
            ...
            case 5:str = "zhangfan";message="人脸识别通过，请按钮进入系统"; break;
            default: str = "Error";message="请对准摄像头识别人脸"; break;
            }
             cout <<str<<endl;
